    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <!-- <a href="http://localhost/AULA-ANNYANG/Usuarios/1">
                
                    <button class="btn btn-primary">Administradores</button>
                
                </a> -->

                <!-- <a href="http://localhost/AULA-ANNYANG/Usuarios/2">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control input-lg" name="id_grado" value="0">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-lg" id="correo" name="correoE" required="">
                        ...
                        <div class="form-group" >
                            ...
                            <input type="hidden" class="form-control input-lg" id="clave" name="claveE" required="">
