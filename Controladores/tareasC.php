...
class TareasC{
        ...
        if (isset($_POST["idSeccion"])) {
            ...
            if ($resultado == true) {
                ...
                echo '<script>
                    ...
                    window.location = "http://localhost/AULA-ANNYANG/Tarea/'.$resultado2["id"].'";
                </script>';
        ...
        if (isset($_POST["id"])) {
            ...
            if ($resultado == true) {
                ...
                echo '<script>
                    ...
                    window.location = "http://localhost/AULA-ANNYANG/Tarea/'.$_POST["id"].'";
                </script>';
    ...
    public function SubirTareaC(){
        ...
        if (isset($_POST["nombre"])) {
            ...
            if($_FILES["tarea"]["type"] == "application/pdf"){
                ...
                $rutaArchivo = "Vistas/Tareas/".$_POST["id_seccion"]."-".$_POST["id_tarea"]."-".$_POST["id_s"]."-".$nombre.".pdf";
            ...
            if($_FILES["tarea"]["type"] == "application/vnd.openxmlformats-officedocument.wordprocessingml.document"){
                ...
                $rutaArchivo = "Vistas/Tareas/".$_POST["id_seccion"]."-".$_POST["id_tarea"]."-".$_POST["id_s"]."-".$nombre.".doc";
            ...
            if($_FILES["tarea"]["type"] == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"){
                ...
                $rutaArchivo = "Vistas/Tareas/".$_POST["id_seccion"]."-".$_POST["id_tarea"]."-".$_POST["id_s"]."-".$nombre.".xlsx";
            ...
            if ($resultado == true) {
                ...
                echo '<script>
                    ...
                    window.location = "http://localhost/AULA-ANNYANG/Tarea/'.$_POST["id_tarea"].'";
                </script>';
    ...
    public function EntregarTarea(){
        ...
        if (isset($_POST["id_tarea"])) {
            ...
            $datosC = array("id_alumno"=>$_POST["id_alumno"], "id_tarea"=>$_POST["id_tarea"], "tarea_alumno"=>$rutaArchivo, "id_seccion"=>$_POST["id_seccion"]);
            ...
            if ($resultado == true) {
                ...
                echo '<script>
                    ...
                    swal({
                        ...
                        type: "success",
                        title: "Su tarea de ha enviado Correctamente",
    ...
    static public function VerNotasC(){
        ...
        if (isset($_POST["nota"])) {
            ...
            if ($resultado == true) {
                ...
                echo '<script>
                    ...
                    window.location = "http://localhost/AULA-ANNYANG/Entregas/'.$_POST["id_tarea"].'";
                </script>';
